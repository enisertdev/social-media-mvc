    ...
    public partial class d : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriendships", x => x.FriendshipId);
                    table.ForeignKey(
                        name: "FK_UserFriendships_AspNetUsers_FollowedId",
                        column: x => x.FollowedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserFriendships_AspNetUsers_FollowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriendships_FollowedId",
                table: "UserFriendships",
                column: "FollowedId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFriendships_FollowerId",
                table: "UserFriendships",
                column: "FollowerId");
